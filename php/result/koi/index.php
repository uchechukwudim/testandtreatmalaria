...
<?php require 'C:\wamp\www\malaria_camp\config\constants.php';
      require 'C:\wamp\www\malaria_camp\php\result\koi\process\index.php';
...
<html>
	...
	<meta property="og:url" content="http://testandtreatmalaria.org/" /> 
        <meta property="og:title" content="<?php echo $Result ?>" />
        ...
        <div id="wrapper">
            <section>
                <header class="resultheader">
                    <img src="<?php echo URL ?>img/dr-koi-header.jpg">
