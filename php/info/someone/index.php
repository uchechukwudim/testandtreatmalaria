        ...
        <div id="wrapper">
            ...
            <section>
                <div class="questions-holder">
                     <h3></h3>
                    <div class="question"><b>Is the person:</b></div>
                        <form method="post" class="ques-form" >
                            ...
                            <div class="opt-holder">    
                                ...
                                <div id="radio-listDiv3" class="radio-listDiv" style=" border-bottom:  1px solid rgba(0, 0, 0, 0.1)"><input type="radio" value="Or Something else"  name="radio" id="radio3" class="css-checkbox" /><label for="radio4" class="css-label radGroup2">Or Something else</label></div>
                            </div>
                    
                            <button onclick="BackToHome()" type="button" class="prev"><img src="<?php echo URL ?>img/left_inactive.png"><span>Back</span></button>  <button  onclick="getCheckFor()" type="button" class="next"> <span>Next</span><img src="<?php echo URL ?>img/right.png"></button>
                      </form>
               </div>
